...
# Data(Train)
train_sal <- read.csv("D:/Data Science Course/Assignments/Naive Bayes/SalaryData_Train.csv")
str(train_sal)
View(train_sal)
...
# Data(Test)
test_sal <- read.csv("D:/Data Science Course/Assignments/Naive Bayes/SalaryData_Train.csv")
str(test_sal)
View(test_sal)
...
library(caret)
confusionMatrix(Model_pred,test_sal$Salary) # Accuracy : 82.2 %
